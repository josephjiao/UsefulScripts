//代码会自动去服务器校对时间只需要在第一行delay设置延迟提交领券的时间，比如延迟1秒提交，就设为1。
// 提前10秒-15秒左右执行代码，然后将验证码输好，代码到时间自动提交。
//用代码的优势：当没用代码的刚刷出来验证码的时候，你已经提交领券了。

//(关键点) : 1.提前输入验证码(验证码url活动之前其实就可用)， 2. 校对服务器时间


var delay = 1;//提交时间（到点前或到点后多少秒领取，提前为负值，单位秒，默认1秒后） 
var count = 0, 
interval = 500; 
